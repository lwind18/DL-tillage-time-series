# v6.6 Spt 02 2022 final model for cnnlstm attention with two classes (CT+RT, MT+NT)
"""
...
if __name__ == "__main__":
    ...
    model_name = RESULT_DIR+name_prefix_no_soket+'.cnnlstmatt.model' +'.'+ str(IN_DEPTH) + '.h5'
    ...
    with strategy.scope():
        ...
        if os.path.isfile(model_name):
            ...
            model=cnnlstm_model.build_att_cnnlstm0(IMG_HEIGHT, IMG_WIDTH, IN_DEPTH, IMG_BANDS, 2)
    ...
    out_test_file = './'+'planet.test.cnnlstm.v6.6'+'.epoch'+str(EPOCHS)+'.batch'+str(BATCH_SIZE)+'.M'+str(METHOD) +'.step' + str(step) + '.'+str(IN_DEPTH) + '.csv'
